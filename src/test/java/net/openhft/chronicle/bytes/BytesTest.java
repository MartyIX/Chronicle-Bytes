...
public class BytesTest {
    ...
    public void testParseUtf8() {
        //System.out.println("BytesTest.testParseUtf8()");
        Bytes bytes = alloc1.elasticBytes(1);
        try {
            //System.out.println("BytesTest.testParseUtf8() *** [1]");
            assertEquals(1, bytes.refCount());
            //System.out.println("BytesTest.testParseUtf8() *** [2]");
            bytes.appendUtf8("starting Hello World");
            //System.out.println("BytesTest.testParseUtf8() *** [3]");
            @NotNull String s0 = bytes.parseUtf8(StopCharTesters.SPACE_STOP);
            //System.out.println("BytesTest.testParseUtf8() *** [4]: s0 =" + s0);
            assertEquals("starting", s0);
            //System.out.println("BytesTest.testParseUtf8() *** [5]");
            @NotNull String s = bytes.parseUtf8(StopCharTesters.ALL);
            //System.out.println("BytesTest.testParseUtf8() *** [6] s=" + s);
            assertEquals("Hello World", s);
            //System.out.println("BytesTest.testParseUtf8() *** [7]");
            assertEquals(1, bytes.refCount());
        } finally {
            bytes.release();
