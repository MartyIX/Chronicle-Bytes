...
//            i ++;
    ...
    public static void parseUtf8(
        ...
        if (appendable instanceof StringBuilder) {
            //System.out.println("BytesInternal.parseUtf8[RandomDataInput](): Instance of StringBuilder");

            if (input instanceof NativeBytesStore) {
                //System.out.println("BytesInternal.parseUtf8[RandomDataInput]() Input instanceof NativeBytesStore");
                ...
                //System.out.println("BytesInternal.parseUtf8[RandomDataInput]() Input instanceof Bytes");
